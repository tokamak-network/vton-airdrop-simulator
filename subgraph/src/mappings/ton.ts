import { Transfer as TransferEvent } from "../../generated/TON/ERC20";
import { Transfer } from "../../generated/schema";
import { getOrCreateAccount, getOrCreateProtocol, ONE } from "./helpers";

export function handleTONTransfer(event: TransferEvent): void {
  ...
  from.tonBalance = from.tonBalance.minus(event.params.value);
  from.contractInteractionCount = from.contractInteractionCount.plus(ONE);
  from.save();

  to.tonBalance = to.tonBalance.plus(event.params.value);
  to.save();
